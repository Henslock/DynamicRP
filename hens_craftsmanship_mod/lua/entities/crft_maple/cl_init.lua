...
function ENT:Draw()
	...
	if LocalPlayer():GetPos():Distance(self:GetPos()) < 550 then
		...
		cam.Start3D2D(Pos+Ang:Up()*30+Ang:Right()*-65, Ang, 0.2)
			draw.RoundedBox( 2, -barwidth*0.5, 25, barwidth, 8, Color(0,0,0,175*alpha) )
			draw.RoundedBox( 2, (-barwidth*0.5 + 3), 27, (barwidth - 6)*barPerc, 4, Color(232, 165, 158,175*alpha) )
