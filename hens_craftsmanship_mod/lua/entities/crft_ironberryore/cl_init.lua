...
function ENT:Draw()
	...
	local name = CRAFTSMANSHIP_MATS_DROP["mat_ironberry"].name
	local ico = nil
	local icoColor = Color(255,255,255,255)
	
	ico = CRAFTSMANSHIP_MATS_DROP["mat_ironberry"].dropicon
	icoColor = CRAFTSMANSHIP_MATS_DROP["mat_ironberry"].dropcolor
