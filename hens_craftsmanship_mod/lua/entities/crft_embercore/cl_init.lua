...
function ENT:Draw()
	...
	local name = CRAFTSMANSHIP_MATS_DROP["mat_embercore"].name
	local ico = nil
	local icoColor = Color(255,255,255,255)
	
	ico = CRAFTSMANSHIP_MATS_DROP["mat_embercore"].dropicon
	icoColor = CRAFTSMANSHIP_MATS_DROP["mat_embercore"].dropcolor
