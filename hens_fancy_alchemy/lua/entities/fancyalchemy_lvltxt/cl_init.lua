...
local falch_ui_lvlTxt =  Material( "materials/fancyalchemy/ui_levelup.png","smooth"  )
...
function ENT:Draw()   
	...
	if LocalPlayer():GetPos():Distance(self:GetPos()) < 1500 then
		...
		cam.Start3D2D(Pos , Ang, 0.28)
				...
				local width = 768
				local height = 512
				surface.SetDrawColor(Color(255,255,255, Lerp((self.time*self.time*self.time)*350 , 255,0)))
